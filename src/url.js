 ...
 * @returns {*}
 */
url.getHashSearchObj = function (key) {
 ...
 * @param object
 */
url.setHashSearch = function (object) {
...
url.delHashSearch = function (arg) {
    var hashSearch = this.getHash(),
        search = '',
        hash = '',
        obj = {},
 ...
 * @returns {boolean}
 */
url.isEqualHost = function (i, j, m) {
    var b = true,
        iO = parseUrl(i),
        jO = parseUrl(j);
